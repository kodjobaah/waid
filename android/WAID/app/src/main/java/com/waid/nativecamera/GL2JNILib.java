...
public class GL2JNILib {
    ...
    public static native void init(int width, int height, int camera, int restart);
    public static native void step();

    public static native void orientationChange(int orient);

    public static native void startZeroMQ(String url, String token);
